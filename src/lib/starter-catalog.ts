// Starter catalog items every new account gets on signup, so the dashboard
// never looks empty for a fresh user. Images are hotlinked Target product
// photos (verified live, not downloaded/redistributed).
export const STARTER_CATALOG = [
  ...
  },
  {
    ...
    price: 25.98,
    stock: 8,
    imageUrl: "https://www.door-parts.com/cdn/shop/files/PXL_20231024_194752296-PhotoRoom_2.png?v=1698252981&width=1000",
  },
  {
    ...
    stock: 22,
    imageUrl:
      "https://cello-foam.transforms.svdcdn.com/production/images/garage-door-insulation-kit/Photo2.jpg?w=1200&h=800&q=40&auto=format&fit=crop&dm=1628863665&s=c868c4f8d8bc22e4322be60e41778535",
  },
  {
    ...
    stock: 6,
    imageUrl:
      "https://target.scene7.com/is/image/Target/GUEST_55fb2397-5450-4324-ad59-192bd23f1574?wid=300&hei=300&fmt=pjpeg",
  },
  {
